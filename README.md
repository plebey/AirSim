...
**TODO:** arducopter и mavlink - дополняющие друг друга вещи, а не аналоги друг друга. Почему у них отдельные папки в прошивках?
...
**TODO:** Судя по всему, часть api расположена в include (что-то глобальное вроде настроек мира..?), а api мультиротора - в src. Хотя в include есть api и для дронов. В чем разница?

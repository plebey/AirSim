...
**TODO:** arducopter (автопилот?) и mavlink (протокол связи) - дополняющие друг друга вещи, а не аналоги друг друга. Почему у них отдельные папки в прошивках ```include/vehicles/multicopter```?

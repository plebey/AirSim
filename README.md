...
1. Open ```Unreal/Environments/Blocks```
2. To generate a .sln file, first run clean.bat, then GenerateProjectFiles.bat
3. After that you can run the project through Visual Studio in DebugGame_Editor and Win64 mode
